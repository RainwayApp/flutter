...
class BuildTvOSCommand extends BuildSubCommand {
  BuildTvOSCommand() {
    ...
    argParser
      ..addFlag('debug',
        negatable: false,
        help: 'Build a debug version of your app (default mode for tvOS simulator builds).',
      )
      ..addFlag('profile',
        negatable: false,
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    final BuildableIOSLikeApp app = await applicationPackages.getPackageForPlatform(TargetPlatform.tvos);
    ...
    final String typeName = artifacts.getEngineType(TargetPlatform.tvos, buildInfo.mode);
